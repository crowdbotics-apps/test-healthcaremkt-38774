"""
Django settings for test_healthcaremkt_38774 project.
...
ROOT_URLCONF = 'test_healthcaremkt_38774.urls'
...
WSGI_APPLICATION = 'test_healthcaremkt_38774.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_healthcaremkt_38774 API",
    "DESCRIPTION": "API documentation for test_healthcaremkt_38774 App",
    "VERSION": "v1",
}
