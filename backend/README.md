...
## Project Structure
    ...
    ├── test_healthcaremkt_38774  # Django project configurations
...
1. Clone this repo and `cd test_healthcaremkt_38774`
...
2. Clone this repo and `cd test_healthcaremkt_38774`
